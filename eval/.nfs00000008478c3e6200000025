#!/bin/bash
#
# Script to run comprehensive evaluation across all datasets and prompting methods
# 
# This script evaluates ambiguity classification performance on:
# - Datasets: ClariQ, AmbigNQ
# - Prompting methods: zero_shot, few_shot, zero_shot_cot, few_shot_cot
#
...
echo -e "${BLUE}======================================================================${NC}"
echo -e "${BLUE}  Running Comprehensive Ambiguity Classification Evaluation${NC}"
echo -e "${BLUE}======================================================================${NC}"
